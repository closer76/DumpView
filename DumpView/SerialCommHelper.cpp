...
void ATLTRACE6( const char* str, ...)
{
}

void ATLTRACE6( const wchar_t* str, ...)
{
}
...
HRESULT CSerialCommHelper:: Init(wxString szPortName, DWORD dwBaudRate,BYTE byParity,BYTE byStopBits,BYTE byByteSize)
{
...
//						AfxMessageBox("Data sent");
                        ::MessageBox( NULL, _T("Data sent"), _T("Message"), MB_OK);
